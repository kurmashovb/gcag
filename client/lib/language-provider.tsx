...
const translations = {
  ...
  ru: {
    ...
    "contact.email": "Эле��тронная почта",
    ...
    "howwework.description":
      "Н��ш упрощённый процесс обеспечивает быструю и соответствующую требованиям регистрацию судов через прямое партнёрство с морскими администрациями",
    ...
    // Footer
    "footer.copyright":
      "© 2025 Африканские услуги регистрации фл��гов. Все права защищены.",
    "footer.disclaimer":
